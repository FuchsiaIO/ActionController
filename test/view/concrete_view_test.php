...
namespace ActionController\View\Test;

class ConcreteViewTest extends \PHPUnit_Framework_TestCase
{
  protected $view;

  protected function setUp()
  {
    $view_factory = new \ActionController\Factory\ViewFactory;
  ...
  {
    $this->assertInstanceOf('ActionController\Registry\TemplateRegistry', $this->view->getViewRegistry());
    $this->assertInstanceOf('ActionController\Registry\TemplateRegistry', $this->view->getLayoutRegistry());
  }
  ...
  {
    $view = new \ActionController\View\Concrete(
      new \ActionController\Registry\TemplateRegistry(array(
        'bar' => __DIR__ . '/templates/bar_template.php',
        '_partial' => __DIR__ . '/templates/_partial.php')),
  ...
  {
    $view = new \ActionController\View\Concrete(
      new \ActionController\Registry\TemplateRegistry(array('foo' => __DIR__ . '/templates/foo_template.php')),
      new \ActionController\Registry\TemplateRegistry
    );
